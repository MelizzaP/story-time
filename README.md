...
A web application that allows users to collaborate through creating a story one word or sentence at a time.  Users can create public tales that any user can edit, or private tales and choose other users to collaborate.  Users can only input one word or sentence at a time.
